    ...
    <View style={[styles.container, { backgroundColor: theme.backgroundPrimary }]}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.drawerGrid}>
            <Button
              title="Left Drawer"
              onPress={() => setLeftDrawerVisible(true)}
              style={styles.drawerButton}
            />
            <Button
              title="Right Drawer"
              variant="outline"
              onPress={() => setRightDrawerVisible(true)}
              style={styles.drawerButton}
            />
            <Button
              title="Top Drawer"
              variant="secondary"
              onPress={() => setTopDrawerVisible(true)}
              style={styles.drawerButton}
            />
            <Button
              title="Bottom Drawer"
      ...
      >
        <View style={styles.drawerContent}>
          ...
          <Text style={[styles.drawerText, { color: theme.textSecondary }]}>
            This drawer slides in from the left side with smooth spring animation and subtle scaling effect.
          </Text>
          <View style={styles.drawerActions}>
            <Button
              title="Close Drawer"
              onPress={() => setLeftDrawerVisible(false)}
              style={{ marginBottom: 8 }}
            />
            <Button
              title="Action Button"
              variant="outline"
              onPress={() => showAlert('Left drawer action pressed!')}
            />
          </View>
        </View>
      </Drawer>
      ...
      >
        <View style={styles.drawerContent}>
          ...
          <Text style={[styles.drawerText, { color: theme.textSecondary }]}>
            This drawer slides in from the right side with smooth spring animation and subtle scaling effect.
          </Text>
          <View style={styles.drawerActions}>
            <Button
              title="Close Drawer"
              onPress={() => setRightDrawerVisible(false)}
              style={{ marginBottom: 8 }}
            />
            <Button
              title="Action Button"
              variant="outline"
              onPress={() => showAlert('Right drawer action pressed!')}
            />
          </View>
        </View>
      </Drawer>
      ...
      <Drawer
        ...
        onClose={() => setTopDrawerVisible(false)}
        position="top"
        size="md"
      >
        <View style={styles.drawerContent}>
          ...
          <Text style={[styles.drawerText, { color: theme.textSecondary }]}>
            This drawer slides down from the top with smooth spring animation and subtle scaling effect.
          </Text>
          <View style={styles.drawerActions}>
            <Button
              title="Close Drawer"
              onPress={() => setTopDrawerVisible(false)}
              style={{ marginBottom: 8 }}
            />
            <Button
              title="Action Button"
              variant="outline"
              onPress={() => showAlert('Top drawer action pressed!')}
            />
          </View>
        </View>
      </Drawer>
      ...
      >
        <View style={styles.drawerContent}>
          ...
          <Text style={[styles.drawerText, { color: theme.textSecondary }]}>
            This drawer slides up from the bottom with smooth spring animation and subtle scaling effect.
          </Text>
          <View style={styles.drawerActions}>
            <Button
              title="Close Drawer"
              onPress={() => setBottomDrawerVisible(false)}
              style={{ marginBottom: 8 }}
            />
            <Button
              title="Action Button"
              variant="outline"
              onPress={() => showAlert('Bottom drawer action pressed!')}
            />
          </View>
        </View>
      </Drawer>
